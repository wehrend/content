...
_https://wehrend.uber.space/docs/digital_logic/01_boolean_algebra/[Boolesche Algebra, grundlegende Logikgatter und ihre
Implementierung]_
...
_http://wehrend.uber.space/docs/digital_logic/03_binary_system/[Binärsysteme (Teil I) und kombinatorische Logik (Teil I)]_
...
_http://wehrend.uber.space/docs/digital_logic/04_signs/[Binärsysteme (Teil II) vorzeichenbehaftete Ganzzahlen]_
